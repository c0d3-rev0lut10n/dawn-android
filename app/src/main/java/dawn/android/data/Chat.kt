...
class Chat(
    ...
    companion object {
        ...
        fun fromSerialized(ser: SerializedChat): Chat {
            ...
            return Chat(
                ...
                lastSuccessfulReception = ser.lastSuccessfulReception,
                name = ser.name,
                type = ser.type,
                messages = messages,
                ownKyber = ser.ownKyber,
                remoteKyber = ser.remoteKyber,
                ownCurve = ser.ownCurve,
                remoteCurve = ser.remoteCurve,
                remoteCurvePfs = ser.remoteCurvePfs,
                ownPFS = ser.ownPFS,
    ...
    fun intoSerializable(): SerializedChat {
        ...
        return SerializedChat(
            ...
            lastSuccessfulReception = lastSuccessfulReception,
            name = name,
            type = type,
            messages = serializedMessages,
            ownKyber = ownKyber,
            remoteKyber = remoteKyber,
            ownCurve = ownCurve,
            remoteCurve = remoteCurve,
            remoteCurvePfs = remoteCurvePfs,
            ownPFS = ownPFS,
            remotePFS = remotePFS,
            pfsSalt = pfsSalt,
            mdcSeed = mdcSeed,
